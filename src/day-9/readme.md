...
To best protect the oasis, your environmental report should include a prediction of the next value in each history. To do this, 
1. start by making a new sequence from the difference at each step of your history. 
